...
% Stage 1: 60° -> 180°
tic;
H_180_60 = Possion_edit(H60, H180, tol);
t1 = toc;
fprintf("Poisson editing (300°–60°), tol = %.0e, time = %.2f s\n", tol, t1);

% Stage 2: (60-180) -> 300°
tic;
H_300_60_180 = Possion_edit(H_180_60, H300, tol);
t2 = toc;
...
title('Poisson (180°–60°)','FontSize',9,'Interpreter','tex');

nexttile;
imagesc(H_300_60_180_norm); axis image off;
title('Poisson ((180°–60°)–300°)','FontSize',9,'Interpreter','tex');
